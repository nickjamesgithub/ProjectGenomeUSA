...
### BELOW THE LINE ###
df_untenable = df.loc[df["Genome_classification_beginning"]=="UNTENABLE"]
df_trapped = df.loc[df["Genome_classification_beginning"]=="TRAPPED"]
df_brave = df.loc[df["Genome_classification_beginning"]=="BRAVE"]
df_fearless = df.loc[df["Genome_classification_beginning"]=="FEARLESS"]

### ABOVE THE LINE ###
df_challenged = df.loc[df["Genome_classification_beginning"]=="CHALLENGED"]
df_virtuous = df.loc[df["Genome_classification_beginning"]=="VIRTUOUS"]
df_famous = df.loc[df["Genome_classification_beginning"]=="FAMOUS"]
df_legendary = df.loc[df["Genome_classification_beginning"]=="LEGENDARY"]
...
if genome_class == "Untenable":
    ...
    for i in range(len(df_untenable)):
        ...
        # North East
        if (untenable_i["EP/FE_end"] > 0) and (untenable_i["Revenue_growth_end"] >= 0):
            print("North East")
...
if genome_class == "Fearless":
    ...
    for i in range(len(df_fearless)):
        ...
        # North West
        if (fearless_i["EP/FE_end"] > 0) and (fearless_i["Revenue_growth_end"] < 0.2):
            print("North East")
...
if genome_class == "Legendary":
    ...
    for i in range(len(df_legendary)):
        ...
        # South West
        if (legendary_i["EP/FE_end"] < 0) and (legendary_i["Revenue_growth_end"] < 0.2):
            print("South west")
...
if genome_class == "Challenged":
    ...
    for i in range(len(df_challenged)):
        ...
        # South East
        if (challenged_i["EP/FE_end"] < 0) and (challenged_i["Revenue_growth_end"] >= 0):
            print("South East")
...
if genome_class == "Trapped":
    ...
    for i in range(len(df_trapped)):
        ...
        # NORTH EAST
        if (trapped_i["EP/FE_end"] >= 0) and (trapped_i["Revenue_growth_end"] >= 0.10):
            print("North East")
            trapped_north_east_list.append(trapped_i)
        # NORTH
        if (trapped_i["EP/FE_end"] >= 0) and (trapped_i["Revenue_growth_end"] < 0.10) and (trapped_i["Revenue_growth_end"] > 0):
            print("North")
        ...
        # NORTH WEST
        if (trapped_i["EP/FE_end"] >= 0) and (trapped_i["Revenue_growth_end"] < 0):
            print("North West")
        ...
        # STABLE
        if (trapped_i["EP/FE_end"] < 0) and (trapped_i["Revenue_growth_end"] > 0) and (trapped_i["Revenue_growth_end"] < 0.1):
            print("Stable")
...
if genome_class == "Brave":
    ...
    for i in range(len(df_brave)):
        ...
        # NORTH EAST
        if (brave_i["EP/FE_end"] >= 0) and (brave_i["Revenue_growth_end"] >= 0.20):
            print("North East")
            brave_north_east_list.append(brave_i)
        # NORTH
        if (brave_i["EP/FE_end"] >= 0) and (brave_i["Revenue_growth_end"] < 0.20) and (brave_i["Revenue_growth_end"] > 0.10):
            print("North")
        ...
        # NORTH WEST
        if (brave_i["EP/FE_end"] >= 0) and (brave_i["Revenue_growth_end"] < 0.1):
            print("North West")
        ...
        # STABLE
        if (brave_i["EP/FE_end"] < 0) and (brave_i["Revenue_growth_end"] > 0.1) and (brave_i["Revenue_growth_end"] < 0.2):
            print("Stable")
...
if genome_class == "Virtuous":
    ...
    for i in range(len(df_virtuous)):
        ...
        # South East
        if (virtuous_i["EP/FE_end"] < 0) and (virtuous_i["Revenue_growth_end"] >= 0.10):
            print("South East")
            virtuous_south_east_list.append(virtuous_i)
        # South
        if (virtuous_i["EP/FE_end"] < 0) and (virtuous_i["Revenue_growth_end"] < 0.10) and (virtuous_i["Revenue_growth_end"] > 0):
            print("South")
            virtuous_south_list.append(virtuous_i)
        # South West
        if (virtuous_i["EP/FE_end"] < 0) and (virtuous_i["Revenue_growth_end"] < 0):
            print("South West")
        ...
        # Stable
        if (virtuous_i["EP/FE_end"] > 0) and (virtuous_i["Revenue_growth_end"] > 0) and (virtuous_i["Revenue_growth_end"] < 0.1):
            print("Stable")
...
if genome_class == "Famous":
    ...
    for i in range(len(df_famous)):
        ...
        # South East
        if (famous_i["EP/FE_end"] < 0) and (famous_i["Revenue_growth_end"] >= 0.20):
            print("South East")
            famous_south_east_list.append(famous_i)
        # South
        if (famous_i["EP/FE_end"] < 0) and (famous_i["Revenue_growth_end"] < 0.20) and (famous_i["Revenue_growth_end"] > 0.1):
            print("South")
            famous_south_list.append(famous_i)
        # South West
        if (famous_i["EP/FE_end"] < 0) and (famous_i["Revenue_growth_end"] < 0.1):
            print("South West")
        ...
        # STABLE
        if (famous_i["EP/FE_end"] > 0) and (famous_i["Revenue_growth_end"] > 0.1) and (famous_i["Revenue_growth_end"] < 0.2):
            print("Stable")
